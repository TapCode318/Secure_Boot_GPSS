        ...
        if (rst_i) begin
            ...
            if (aw_seen_q && w_seen_q && !axi_bvalid_o) begin
                ...
                if ((awlen_q != 8'd0) || !wlast_q) begin
                    ...
                    case (wr_offset_w)
                        ...
                        8'h20: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[255:224] <= wdata_q;
                        8'h24: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[223:192] <= wdata_q;
                        8'h28: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[191:160] <= wdata_q;
                        8'h2C: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[159:128] <= wdata_q;
                        8'h30: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[127:96]  <= wdata_q;
                        8'h34: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[95:64]   <= wdata_q;
                        8'h38: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[63:32]   <= wdata_q;
                        8'h3C: if (ALLOW_KEY_WRITE && wstrb_q != 4'b0000) aes_key_o[31:0]    <= wdata_q;

                        8'h40: if (wstrb_q != 4'b0000) aes_ctr_init_o[127:96]  <= wdata_q;
                        8'h44: if (wstrb_q != 4'b0000) aes_ctr_init_o[95:64]   <= wdata_q;
                        8'h48: if (wstrb_q != 4'b0000) aes_ctr_init_o[63:32]   <= wdata_q;
                        8'h4C: if (wstrb_q != 4'b0000) aes_ctr_init_o[31:0]    <= wdata_q;

                        8'h80: if (wstrb_q != 4'b0000) aes_data_in_o[127:96]   <= wdata_q;
                        8'h84: if (wstrb_q != 4'b0000) aes_data_in_o[95:64]    <= wdata_q;
                        8'h88: if (wstrb_q != 4'b0000) aes_data_in_o[63:32]    <= wdata_q;
                        8'h8C: if (wstrb_q != 4'b0000) aes_data_in_o[31:0]     <= wdata_q;
            ...
            if (axi_arready_o && axi_arvalid_i && !axi_rvalid_o) begin
                ...
                case (rd_offset_w)
                    ...
                    8'h20: axi_rdata_o <= aes_key_o[255:224];
                    8'h24: axi_rdata_o <= aes_key_o[223:192];
                    8'h28: axi_rdata_o <= aes_key_o[191:160];
                    8'h2C: axi_rdata_o <= aes_key_o[159:128];
                    8'h30: axi_rdata_o <= aes_key_o[127:96];
                    8'h34: axi_rdata_o <= aes_key_o[95:64];
                    8'h38: axi_rdata_o <= aes_key_o[63:32];
                    8'h3C: axi_rdata_o <= aes_key_o[31:0];

                    8'h40: axi_rdata_o <= aes_ctr_init_o[127:96];
                    8'h44: axi_rdata_o <= aes_ctr_init_o[95:64];
                    8'h48: axi_rdata_o <= aes_ctr_init_o[63:32];
                    8'h4C: axi_rdata_o <= aes_ctr_init_o[31:0];

                    8'h80: axi_rdata_o <= aes_data_in_o[127:96];
                    8'h84: axi_rdata_o <= aes_data_in_o[95:64];
                    8'h88: axi_rdata_o <= aes_data_in_o[63:32];
                    8'h8C: axi_rdata_o <= aes_data_in_o[31:0];
                    8'h90: axi_rdata_o <= {16'd0, aes_keep_in_o};

                    8'hA0: axi_rdata_o <= out_data_q[127:96];
                    8'hA4: axi_rdata_o <= out_data_q[95:64];
                    8'hA8: axi_rdata_o <= out_data_q[63:32];
                    8'hAC: axi_rdata_o <= out_data_q[31:0];
